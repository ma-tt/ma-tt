...
- 📰 [chassy-cms](https://github.com/magnabytes/chassy-cms) - Edit your website content like WordPress, without the bloat or security headaches. A lightweight, secure, drop-in admin panel that generates pure static HTML on virtually any web hosting platform.
- 📟 [arduino-mini-dashboard](https://github.com/ma-tt/arduino-mini-dashboard) - A collection of tiny Arduino/ESP apps for OLED displays.
