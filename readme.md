...
- 📰 [chassy-cms](https://github.com/magnabytes/chassy-cms) - A lightweight, secure WordPress replacement: drop-in admin panel that generates pure static HTML on virtually any web hosting platform.
